...
const AddToy = () => {
    ...
    const handleAddToy = (event) => {
        ...
        fetch(`https://toy-marketplace-server-chi-seven.vercel.app/addtoy`, {
            method: "POST",
            headers: {
                ...
                <form onSubmit={handleAddToy} className="card w-4/5 shadow-2xl bg-base-100 mx-auto my-4 ">
                    <div className="card-body grid lg:grid-cols-3">
                        <div className="form-control">
                            ...
                            <input type="text" placeholder="Seller Name" name="seller" className="input input-bordered" defaultValue={user?.displayName} />
                        </div>
                        <div className="form-control">
                            <label className="label">
